...
<!-- 
              ...
              <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Manage Reports</span>
            </a>
					</li>
					
			<li class="sidebar-item">
						<a class="sidebar-link" href="manage_feedback.php">
              <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Manage Feedback</span>
            </a>
					</li>
